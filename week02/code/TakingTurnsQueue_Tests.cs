...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: The Dequeue method was interacting with the first index, instead of the last
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: I kept decreasing the infinite persons number, but the test wanted him to keep at 0, so I made the turns return to 0 if it ever reaches negative amounts.
